...
//		});
	...
	class ViewHodler {
		/**  chatfrom_icon 左边头像   右边头像  chatto_icon  imagView */
		ImageView fromIcon, toIcon;
		/**  fromContent 左边的消息  toContent 右边的消息  textView  time  发送消息的时间 */
		TextView fromContent, toContent, time;
		/**  fromContainer  左边消息发送的布局   LinearLayout \\  toContainer  右边消息发送的布局  RelativeLayout >>>>都用的 ViewGroup */
